<section
    ...
    <div class="absolute inset-0 z-10 bg-[linear-gradient(to_bottom,_rgba(44,0,0,0)_0%,_#140000_90%)]"></div>

    <img
        src="<?= inv_asset('img/foto-closing.jpeg') ?>"
        class="absolute top-0 z-0 h-[90%] w-full object-cover"
        alt="bg" />
